...
(function() {
    ...
    PAYPAL.Marketing.FloatingBar = function(bar, options) {
        ...
        if($('html').attr('data-device-type') === 'dedicated') {
    ...
    PAYPAL.Marketing.FloatingBar.prototype = {
        ...
        _attachEvents: function() {
            ...
            if($('html').attr('data-device-type') !== 'dedicated') {
                var jumpBarSelect = $('#jump-bar-select');
                if(jumpBarSelect.length > 0) {
                    this._events.push(jumpBarSelect.on('change', this._onSelectChange.bind(this)));
                }
            }
        },
        ...
        _onSelectChange: function(event) {
            ...
            if(lang.indexOf(usLocal) > -1) {
                var $this = $('#jump-bar-select').find("option:selected"),
        ...
        _scrollTo: function(tgt, options) {
            ...
            $(opt.origin).animate({
                scrollTop: topOffset + opt.offset
